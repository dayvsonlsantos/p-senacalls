...
export default function Perfil() {
    ...
    function openModalCamera() { setModalCamera(true) }

    function closeModalCamera() { setModalCamera(false) }
    ...
    return (
        <>
            ...
            {
                isModalCamera ? (
                    <OpenCamera closeModalCamera={closeModalCamera} />
                ) : null
            }
            <Head>
                ...
                <div className="flex-grow mb-28">
                    ...
                    <main className="flex items-center justify-center flex-col w-full ">
                        ...
                        <section className='w-4/5 flex items-center justify-center flex-col'>
                            <button onClick={openModalCamera} className='my-4 flex items-center justify-center'>
